...
#     net.load_state_dict(torch_load_legacy('/workspace/pytracking/pytracking/networks/super_dimp.pth.tar')['net'])
    ...
    lr_scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=15, gamma=0.6)
